  ...
  return (
    <>
      <div className="footer">
        <div className="footer-container">
          <div className="website-details">
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit quod, nisi suscipit
              iusto pariatur quis iure necessitatibus tempore nostrum soluta!
            </p>
      ...
      <div className="copyright-section">
        <p>&copy;2022 Raihan Bin Islam</p>
      </div>
    </>
  );
};
